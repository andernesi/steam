class JogosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @jogo.save
        format.html { redirect_to action: "index", notice: 'Jogo was successfully created.' }
  ...
  private
    ...
    def jogo_params
      params.require(:jogo).permit(:titulo, :descricao, :desenvolvedor, :lancamento, :classificacao_id)
    end
end
